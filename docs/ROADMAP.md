...
- T14.17 — Continuous learning everywhere. Calibrates T14.16.5 thresholds at curriculum time, populates persona refresh corpus, implements `personaDimensions` semantic clustering for stratified refresh, upgrades `computeFineTypeCoverage` to cortex-resident fineType readout, wires learned `cluster.intentReadout()` from the fineType region's argmax. Final T14 milestone. Branch merges to main after T14.17 ships.
