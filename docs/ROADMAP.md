...
- T14.12 — Bidirectional cortex pipeline (parseSentence DELETED, engine.processAndRespond rewired to use readText/hearPhoneme, LanguageCortex.generate wrapper deleted)
