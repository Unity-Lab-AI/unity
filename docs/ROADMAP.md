...
- T14.7 — delete `_TYPE_TRANSITIONS` hardcoded English type-bigram matrix and `_OPENER_TYPES` Set; type transitions become fully learned from corpus observation with no seed
