...
- T14.15 — Wire ALL remaining language consumers to the unified pipeline (brain-3d.js commentary, component-synth.js parse references, any other `innerVoice.languageCortex.X` call sites outside chat/boot)
